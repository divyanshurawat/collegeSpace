...
class AddNews extends StatefulWidget {
  ...
  AddNews({this.currentUserid, this.link});
  @override
  _EditProfileState createState() => _EditProfileState();
}

class _EditProfileState extends State<AddNews> {
  ...
  Future<Uri> createDynamicLink(@required String username) async {
    ...
    final DynamicLinkParameters parameters = DynamicLinkParameters(
      uriPrefix: 'https://collegespace.page.link',
      link:
      Uri.parse('https://poly.page.link/groupinvite?username=$username'),
      androidParameters: AndroidParameters(
        packageName: 'com.digest.collegespace',
        minimumVersion: 1,
      ),
      iosParameters: IosParameters(
        bundleId: 'com.digest.collegespace',
        minimumVersion: '1',
        appStoreId: '',
      ),
    );
